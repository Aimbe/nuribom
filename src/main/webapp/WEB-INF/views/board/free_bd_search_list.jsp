          ...
          <div class="real-content">
		 	...
		 	<div class="user-top">
		      ...
		      <h3>
		         ...
		         <c:out value="${searchMsg }"/>    
		            
			 </h3>

                <div class="user-search-box">

                  <h6 class="user-mini-title">자유게시판 :: 검색 결과 게시글</h6>
                  <div class="user-search-inner-box">
                    <form method="post" action="${pageContext.request.contextPath}/free_board_search_proc.bom">
                      ...
                      oninput = "setCustomValidity('')" value="${param.search }">
		 	...
		 	<!-- 자유게시판 글 테이블 -->
		 	 <%@include file="_free_board_search_list.jsp" %>
		 	<!-- 글작성 이동 -->
...
$('.prev').click(function(){
	...
	<c:if test="${pn gt 1 }">
		location.href="${pageContext.request.contextPath}/free_board_search_proc.bom?pg=${pn-1}&search=${param.search}";
	</c:if>
});
...
function movePage(e){
    ...
    location.href ="${pageContext.request.contextPath}/free_board_search_proc.bom?pg="+e+"&search=${param.search}";
