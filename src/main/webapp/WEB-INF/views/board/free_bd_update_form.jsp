	 ...
	 <div class="container submain-content-box">
 	 <%@include file="../common/board/_mind_board_category.jsp" %>
          ...
          <div class="real-content">
              ...
              <form action="${pageContext.request.contextPath}/free_board_update_proc.bom" method="post" id="user-edit">
				
				<input type="hidden" name ="id" value="${board.id}">
				<input type="hidden" name ="mbId" value="${board.mbId}">
           		<input type="hidden" name ="writer" value="${board.writer}">
           		<input type="hidden" name ="view" value="${board.view}">
           	    <input type="text" name="title" maxlength="64" class="user-title" placeholder="제목을 입력해주세요." value="${board.title}" required>
                <div id="editor"></div>
