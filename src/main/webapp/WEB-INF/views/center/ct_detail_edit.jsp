 ...
 <%@include file="../common/board/_visual.jsp" %><!--비주얼-->
      ...
      <div class="container main-container">
        ...
        <div class="info_main_wrapper">
          ...
          <div class="reviews_wrapper">
               ...
               <c:forEach var="rv" items="${rvList}">
                ...
                <div class="user"><i class="fas fa-user fa-3x"></i></div>
                    ...
                    <input type="button" value="수정" id="review_change${rv.reviewId}" class="review_change" />
              ...
              <div class="paging">
                ...
                <a href="center_detail_edit.bom?rvId=${rvId}&pg=${pg-1}#main_reviews"><i class="fas fa-chevron-circle-left fa-2x"></i></a>
                </c:if>
                <c:if test="${pg != maxPg  && maxPg>0}">
                <a href="center_detail_edit.bom?rvId=${rvId}&pg=${pg+1}#main_reviews"
 		...
 		<form action="center_detail_rv_edit.bom#main_review" id="review_form" method="get">
              ...
              <div class="board">
                  <textarea
                    ...
                    rows="10"
             		form="review_form"
             		autofocus
                  ><c:out value ="${editRv.reviewContent}"/></textarea>
             	  <c:if test="${!empty mbPKId }">
                	  <input type="submit" class="reviewSubmit" value="수정하기" id="register_review" />
                  	</c:if>
